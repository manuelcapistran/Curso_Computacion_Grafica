...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "practica extra, Capistran Ponce Manuel Emiliano", nullptr, nullptr);
...
void DoMovement()
{
	...
	if (keys[GLFW_KEY_0])  // Inclinar cuerpo hacia atrás
	{
		bodyIncline -= 0.25f;
		if (bodyIncline >= 60.0f) // Máximo 60 grados
			bodyIncline = 60.0f;
	}
