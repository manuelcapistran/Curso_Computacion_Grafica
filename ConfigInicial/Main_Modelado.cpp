...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado geometrico Practica 4, Capistran Ponce Manuel Emiliano", nullptr, nullptr);
...
//*******************************************************************************************************************************************************************+
		...
		//cabeza mono
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.6f, 0.5f, 0.3f));
		model = glm::translate(model, glm::vec3(0.25f, 1.5f, 0.3f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
